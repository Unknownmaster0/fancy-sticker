  ...
  return (
    <div className="min-h-80 max-w-4xl mx-auto my-8 w-full font-primary">
      <table className="w-full">
        <thead>
          <tr className="uppercase text-sm text-primary-neon dark:text-light border-b border-primary dark:border-light">
        ...
        <tbody className="divide-y divide-primary dark:divide-light">
          {cartItems.map((item) => (
            <tr
              key={item.productId}
              className="text-sm sm:text-base text-primary-neon dark:text-light text-center"
            >
              <td className="px-4 sm:px-6 py-4 flex items-center">
                ...
                >
                  ...
                  />
                  <span className="text-primary-neon dark:text-light hover:underline">
                    {item.name}
                  </span>
                </Link>
              </td>
              ...
              <td className="px-4 sm:px-6 py-4">
                <button
                  ...
                  className="text-primary-neon dark:text-red-400 border border-primary dark:border-red-400 p-2 rounded hover:bg-lighter dark:hover:bg-gray-700"
                >
          ...
          {cartItems.length > 0 && (
            <tr className="text-center">
              ...
              <td className="text-lg text-primary-neon dark:text-blue-400 font-medium px-4 sm:px-6 py-4">
                ${subtotal}
              </td>
              <td></td>
            </tr>
