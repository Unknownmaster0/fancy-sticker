...
const About = () => {
  const h3Style =
    "text-lg font-semibold text-primary-neon dark:text-light mb-2";
  const pStyle = "text-text-light-muted dark:text-text-muted";

  return (
    <div className="max-w-6xl mx-auto px-6 py-8 font-primary">
      <PageTitle title="About Us" />
      {/* About Us Content */}
      <p className="leading-6 mb-8 text-text-light-muted dark:text-text-muted">
        <span className="text-lg font-semibold text-primary-neon dark:text-light">
          eazy sticker
        </span>{" "}
      ...
      <h2 className="text-2xl leading-8 font-bold text-primary-neon dark:text-light mb-6">
        Why Choose Us?
      </h2>
